...
namespace CourseAPI.Api.Migrations.Application
{
    [DbContext(typeof(ApplicationDbContext))]
    [Migration("20250721212100_Add_Habit")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseAPI.Api.Entities.Habit", b =>
                {
                    ...
                    b.ToTable("habits", "course");
                });

            modelBuilder.Entity("CourseAPI.Api.Entities.Habit", b =>
                {
                    b.OwnsOne("CourseAPI.Api.Entities.Frequency", "Frequency", b1 =>
                        {
                    ...
                    b.OwnsOne("CourseAPI.Api.Entities.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("CourseAPI.Api.Entities.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
