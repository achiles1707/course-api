...
namespace CourseAPI.Api.DTOs.Habits;
...
internal static class HabitMappings
{
    ...
    public static Habit ToEntity(this CreateHabitDto dto)
    {
        Habit habit = new()
        {
            ...
            Type = dto.Type,
            Frequency = new Frequency { Type = dto.Frequency.Type, TimesPerPeriod = dto.Frequency.TimesPerPeriod },
            Target = new Target { Value = dto.Target.Value, Unit = dto.Target.Unit },
            Status = HabitStatus.Ongoing,
            IsArchived = false,
            EndDate = dto.EndDate,
            Milestone =
                dto.Milestone is not null ? new Milestone { Target = dto.Milestone.Target, Current = 0 } : null,
    ...
    public static void UpdateFromDto(this Habit habit, UpdateHabitDto dto)
    {
        ...
        habit.Frequency = new Frequency { Type = dto.Frequency.Type, TimesPerPeriod = dto.Frequency.TimesPerPeriod };
